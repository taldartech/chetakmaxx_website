(function () {
  ...
  (function setupFloatingActions() {
    if (document.getElementById('cmx-floating-actions')) return;

    var wrap = document.createElement('div');
    wrap.id = 'cmx-floating-actions';
    wrap.className = 'cmx-floating-actions';

    var wa = document.createElement('a');
    wa.id = 'whatsapp-float';
    wa.className = 'cmx-whatsapp-float';
    wa.href = 'https://wa.me/917424979752';
    wa.target = '_blank';
    ...
    if (footer && typeof IntersectionObserver !== 'undefined') {
      var io = new IntersectionObserver(
        function (entries) {
          ...
          wrap.classList.toggle('cmx-floating-actions--raised', raised);
        },
